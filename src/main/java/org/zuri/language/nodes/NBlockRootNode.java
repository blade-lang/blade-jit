...
public final class NBlockRootNode extends RootNode {
  ...
  public NBlockRootNode(ZuriLanguage language, NBlockStmtNode block, String name) {
    this(language, FrameDescriptor.newBuilder().build(), block, name);
  }

  public NBlockRootNode(ZuriLanguage language, FrameDescriptor frameDescriptor, NBlockStmtNode block, String name) {
    this(language, frameDescriptor, block, name, null);
  }

  public NBlockRootNode(ZuriLanguage language, FrameDescriptor frameDescriptor, NBlockStmtNode block, String name, SourceSection sourceSection) {
