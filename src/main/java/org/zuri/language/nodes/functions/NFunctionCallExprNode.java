...
public abstract class NFunctionCallExprNode extends NNode {
  ...
  protected Object doVariableLessSize(VirtualFrame frame, FunctionObject function,
                                      @Cached @Cached.Shared("dispatchNode") NFunctionDispatchNode dispatchNode,
                                      @Cached("function") FunctionObject cachedFunction,
                                      @Cached(value = "languageContext()", neverDefault = false) @Cached.Shared("group") ZuriContext context,
  ...
  protected Object instantiateNonConstructor(VirtualFrame frame, Object object) {
    ...
    throw ZuriRuntimeError.error(this, "'", object, "' is not a callable function");
  }
   ...
   */
//  @ExplodeLoop
  private Object[] expandLessVarArguments(FunctionObject function, Object[] arguments, Shape listShape, ZuriClass listClass) {
   ...
   */
//  @ExplodeLoop
  private Object[] expandMoreVarArguments(FunctionObject function, Object[] arguments, Shape listShape, ZuriClass listClass) {
    int functionArity = function.argumentsCount;
    int finalLength = functionArity + 1;
    Object[] ret = new Object[finalLength];
   ...
   */
//  @ExplodeLoop
  private Object[] expandNoVarArguments(FunctionObject function, Object[] arguments, Shape listShape, ZuriClass listClass) {
