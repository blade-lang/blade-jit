...
public final class ZString {
  ...
  public static boolean equals(TruffleString a, TruffleString b, TruffleString.EqualNode equalNode) {
    return equalNode.execute(a, b, ZuriLanguage.ENCODING);
  }

  public static long length(TruffleString string, TruffleString.CodePointLengthNode lengthNode) {
    return lengthNode.execute(string, ZuriLanguage.ENCODING);
  }
  ...
  public static Object substring(TruffleString string, int startIndex, int length, TruffleString.SubstringNode substringNode) {
    return substringNode.execute(string, startIndex, length, ZuriLanguage.ENCODING, true);
  }
  ...
  public static TruffleStringBuilder builder() {
    return TruffleStringBuilder.create(ZuriLanguage.ENCODING);
  }

  public static TruffleString.CodePointSet createCodePointSet(int[] set) {
    return TruffleString.CodePointSet.fromRanges(set, ZuriLanguage.ENCODING);
  }
}
