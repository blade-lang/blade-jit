...
public final class DictionaryObject extends ZuriObject {
  private static final DynamicObjectLibrary UNCACHED_OBJ = DynamicObjectLibrary.getUncached();

  public DictionaryObject(Shape shape, ZuriClass classObject, Object[] keys, Object[] values) {
