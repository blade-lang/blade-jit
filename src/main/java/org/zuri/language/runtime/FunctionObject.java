...
public final class FunctionObject extends ZuriObject {
  ...
  public FunctionObject(Shape shape, ZuriClass classObject, String name, RootCallTarget target, int argumentsCount) {
    this(shape, classObject, name, target, argumentsCount, false);
  }

  public FunctionObject(Shape shape, ZuriClass classObject, String name, RootCallTarget target, int argumentsCount, boolean variadic) {
  ...
  private boolean isRemValue(Object value) {
    return ZuriTypesGen.isImplicitLong(value) ||
      ZuriTypesGen.isImplicitDouble(value) ||
      ZuriTypesGen.isBoolean(value) ||
      value == ZuriNil.SINGLETON ||
      value instanceof String ||
      value instanceof TruffleString ||
      value instanceof ZuriObject;
  }
}
