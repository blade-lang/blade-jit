...
public class ZuriObject extends DynamicObject {
  public final DynamicObject classObject;

  public ZuriObject(Shape shape, DynamicObject classObject) {
    super(shape);
  ...
  public String getClassName() {
    return ((ZuriClass) classObject).name;
  }
  ...
  static final class IsIdenticalOrUndefined {
    @Specialization
    static TriState doSLObject(ZuriObject receiver, ZuriObject other) {
      return TriState.valueOf(receiver == other);
    }

    @Fallback
    static TriState doOther(ZuriObject receiver, Object other) {
