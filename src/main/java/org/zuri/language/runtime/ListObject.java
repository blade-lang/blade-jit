...
public final class ListObject extends ZuriObject {
  @CompilerDirectives.CompilationFinal(dimensions = 1)
  private Object[] items;

  public ListObject(Shape shape, ZuriClass classObject, Object[] objects) {
  ...
  public ListObject getSlice(int start, int end) {
    ...
    return new ListObject(getShape(), (ZuriClass) classObject, objects);
  }
