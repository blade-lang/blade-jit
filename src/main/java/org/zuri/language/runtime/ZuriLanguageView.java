...
public final class ZuriLanguageView implements TruffleObject {

  final Object delegate;

  ZuriLanguageView(Object delegate) {
  ...
  public static Object create(Object value) {
    ...
    return new ZuriLanguageView(value);
  }

  private static boolean isPrimitiveOrFromOtherLanguage(Object value) {
    InteropLibrary interop = InteropLibrary.getFactory().getUncached(value);
    try {
      return !interop.hasLanguage(value) || interop.getLanguage(value) != ZuriLanguage.class;
  ...
  public static Object forValue(Object value) {
    ...
    try {
      if (lib.hasLanguage(value) && lib.getLanguage(value) == ZuriLanguage.class) {
        return value;
      } else {
        return create(value);
      }
  ...
  boolean hasMetaObject(@CachedLibrary("this.delegate") InteropLibrary interop) {
    for (ZuriType type : ZuriType.PRECEDENCE) {
