...
public class GenerateAst {
  ...
  private static final List<String> STMT_DEFINITION = Arrays.asList(
    ...
    "Import     : String path, Expr.Identifier name, List<Expr.Identifier> elements, boolean all",
  ...
  private static void defineAst(String outputDir, String baseName, List<String> types) throws IOException {
    ...
    writer.println("// This file was generated by the tools.zuri.GenerateAst");
    writer.println("package org.zuri.language.parser.ast;");
    writer.println();
    writer.println("import org.zuri.language.parser.Token;");
